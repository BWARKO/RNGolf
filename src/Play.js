class Play extends Phaser.Scene {
    ...
    create() {
        ...
        // add displays
        this.scoreMid = this.add.text(width/2, this.BORDER_PADDING, 'Score: 0', this.TEXT_CONFIG).setOrigin(0.5,0)
        this.shotLeft = this.add.text(this.BORDER_PADDING, this.BORDER_PADDING, 'Shots: 0', this.TEXT_CONFIG).setOrigin(0,0)
        this.percentRight = this.add.text(width - this.BORDER_PADDING, this.BORDER_PADDING, 'Percent Made: %0', this.TEXT_CONFIG).setOrigin(1,0)
        ...
        this.input.on('pointerdown', (pointer) => {
            ...
            this.shotCount += 1
            this.shotLeft.text = `Shots: ${this.shotCount}`
        ...
        this.physics.add.collider(this.ball, this.cup, (ball, cup) => {
            ...
            // score handle
            this.score += 1
            this.percentMade = Phaser.Math.RoundTo(((this.score/this.shotCount) * 100), 0)

            this.scoreMid.text = `Score: ${this.score}`
            this.percentRight.text = `Percent Made: %${this.percentMade}`
        })
